...
class SuggestionItem(_message.Message):
    __slots__ = ("type", "id", "title", "slug", "cover_url", "authors", "score", "readers", "app_avg_rating", "app_rating_count", "ol_avg_rating", "ol_rating_count", "work_id", "language")
...
class SearchResult(_message.Message):
    __slots__ = ("type", "id", "title", "slug", "cover_url", "authors", "relevance_score", "author_slugs", "series_slug", "book_count", "app_avg_rating", "app_rating_count", "ol_avg_rating", "ol_rating_count", "readers", "work_id", "language")
    TYPE_FIELD_NUMBER: _ClassVar[int]
    ID_FIELD_NUMBER: _ClassVar[int]
    TITLE_FIELD_NUMBER: _ClassVar[int]
    SLUG_FIELD_NUMBER: _ClassVar[int]
...
class UpdateBookRequest(_message.Message):
    __slots__ = ("book_id", "title", "slug", "description", "first_sentence", "language", "original_publication_year", "primary_cover_url", "formats_json", "isbn_json", "publisher", "number_of_pages", "external_ids_json", "open_library_id", "google_books_id", "series_id", "series_position", "remove_author_id")
    BOOK_ID_FIELD_NUMBER: _ClassVar[int]
    TITLE_FIELD_NUMBER: _ClassVar[int]
    SLUG_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    ...
    SERIES_ID_FIELD_NUMBER: _ClassVar[int]
    SERIES_POSITION_FIELD_NUMBER: _ClassVar[int]
    REMOVE_AUTHOR_ID_FIELD_NUMBER: _ClassVar[int]
    book_id: int
    title: str
    slug: str
    description: str
...
class UpdateSeriesRequest(_message.Message):
    __slots__ = ("series_id", "name", "slug", "description", "total_books", "remove_author_id")
    SERIES_ID_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    SLUG_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    ...
    total_books: int
    remove_author_id: int
    def __init__(self, series_id: _Optional[int] = ..., name: _Optional[str] = ..., slug: _Optional[str] = ..., description: _Optional[str] = ..., total_books: _Optional[int] = ..., remove_author_id: _Optional[int] = ...) -> None: ...
