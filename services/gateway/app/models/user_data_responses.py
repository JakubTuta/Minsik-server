...
class UpsertRatingRequest(pydantic.BaseModel):
    ...
    readability: typing.Optional[float] = pydantic.Field(default=None, ge=1.0, le=5.0)
    plot_complexity: typing.Optional[float] = pydantic.Field(default=None, ge=1.0, le=5.0)
    humor: typing.Optional[float] = pydantic.Field(default=None, ge=1.0, le=5.0)
