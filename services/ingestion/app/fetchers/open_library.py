...
class OpenLibraryFetcher(BaseFetcher):
    ...
    async def _fetch_work_details(self, work_key: str) -> typing.Optional[typing.Dict[str, typing.Any]]:
        url = f"{self.api_url}{work_key}.json"
        return await self._fetch_with_retry(url)

    async def _fetch_author_details(self, author_key: str) -> typing.Optional[typing.Dict[str, typing.Any]]:
    ...
    def _get_author_photo_url(self, author_data: typing.Dict[str, typing.Any]) -> typing.Optional[str]:
        photos = author_data.get("photos")
        if photos and len(photos) > 0:
            return f"https://covers.openlibrary.org/a/id/{photos[0]}-L.jpg"
        return None

    def _extract_description(self, work_data: typing.Dict[str, typing.Any]) -> typing.Optional[str]:
        description = work_data.get("description")
        if isinstance(description, dict):
            return description.get("value")
        return description

    def _extract_publication_year(self, work_data: typing.Dict[str, typing.Any]) -> typing.Optional[int]:
    ...
    def _extract_cover_history(self, work_data: typing.Dict[str, typing.Any], primary_cover_id: typing.Optional[int]) -> list[typing.Dict[str, typing.Any]]:
        cover_history = []
